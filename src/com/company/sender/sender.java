...
public class sender {
    ...
    String fileName;			// filename to be saved by sender
    Vector<byte[]> packetsList;	// list of generated packets
    Timer timer;				// for timeouts
    Semaphore s;				// guard CS for base, nextSeqNum
    boolean isTransferComplete;	// if sender has completely received the file
    ...
    public class OutThread extends Thread {
        ...
        public void run(){
            try{
                ...
                try {
                    // while there are still packets yet to be received by sender
